...
$(function(){
        $('#sub').
            on('focus', function() { var user = document.getElementById("username").value;
                                     var pass = document.getElementById("password").value;
                                     console.log("u inputu sam");
                                     $.ajax({
                                             type: "POST",
                                             url: "loginLog",
                                             data: {u: user, p: pass}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="form-group">
                                    <input type="submit" value="Log in" id="sub" style="display:inline-block" class="btn btn-primary btn-user btn-block"/></div>
